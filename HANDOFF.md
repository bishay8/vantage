...
- **Rebrand exploration (decision pending):** owner wants to rename off "Vantage" (it's crowded in finance — VantageScore / Vantage Bank / Vantage Markets). Coined, availability-screened finalists: **orvo / placo / stedo** (~7/10 ownable; dictionary picks Beacon/Candor/Lodestar/Sterling all scored 2/10 = taken). Needs the owner's hands-on WHOIS + USPTO Class-36 clearance before committing repo/URL.
